...
> Historical prototype record. Proposed integrations and roadmap items below are preserved in their 2025 context; they are not current production, partnership, or completion claims. See [Intent Systems Prototypes](/work/prototypes) for the reviewed synthesis.
...
- [John Whitton](https://johnwhitton.com/): portfolio and contact.
