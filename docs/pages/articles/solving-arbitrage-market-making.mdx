...
{/* Generated from https://github.com/jincubator/knowledge-base/blob/90e4e0a428c48827a95be63aaa266dd28222e042/collections/solving-arbitrage-market-making/README.md. Do not edit directly. */}
...
- Start with the governed [Salus Work case study](https://www.jincubator.com/work/salus).
- Examine the [retained route-evaluation measurements](https://www.jincubator.com/research/solving/solving).
- Apply the [evidence-aware pipeline architecture](https://www.jincubator.com/architecture/trading-systems/solver).
