...
{/* Generated from https://github.com/jincubator/knowledge-base/blob/0c92f9a60c371fe7daa899589ba49ab01aeb880e/architecture/trading-system-execution-pipelines/README.md. Do not edit directly. */}
...
- Review the [measurement model and retained route-evaluation evidence](/research/solving/solving).
- See the bounded [Salus Work case study](/work/salus).
- Read [Solving, Arbitrage & Market Making](/articles/solving-arbitrage-market-making) for the narrative synthesis.
