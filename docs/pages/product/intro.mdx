...
For the current system-design view and newer diagrams, see [Solver Architecture](/architecture/trading-systems/solver), [Salus Architecture](/architecture/trading-systems/salus), and [Trading Systems Evolution](/architecture/trading-systems/evolution).
