...
> Historical prototype route. This page preserves the original implementation context; the current reviewed synthesis is [Intent Systems Prototypes](/work/prototypes).
