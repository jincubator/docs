...
{/* Historical compatibility route. See the current research page for the maintained account. */}
...
This retained historical account is superseded by the current [High-Performance Route Evaluation](/research/high-performance-route-evaluation) page. Its dated evidence remains illustrative rather than a current implementation reference.
