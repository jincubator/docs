...
Here is more information on the upgrade<sup>9</sup> and the roadmap<sup>10</sup>
...
Following is an excerpt from [Ethereum.org's proof-of-stake documentation](https://ethereum.org/en/developers/docs/consensus-mechanisms/pos/)
...
This proposed block is attested to by other validators who have been assigned as committe members for this slot<sup>6b</sup>.
...
### Checkpoints and Finality<sup>6</sup>
...
messages as well as the EVM. [Appendix E](/research/code/ethereum#appendix-e-data-structures) has links
