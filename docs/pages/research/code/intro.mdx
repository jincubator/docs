...
- [Signing](/research/primitives/signatures)
- [Cryptographic Primitives](/research/primitives/primitives)
- [Consensus](/research/chains/intro)
...
- Bridging
  - [Harmony Horizon Bridge](/research/code/Horizon): Detailed code review
    - [Horizon](https://github.com/johnwhitton/horizon/tree/refactorV2): javascript, solidity
  - [Near Rainbow Bridge](/research/code/ethereum-near): Detailed code review
  ...
  - [Succinct labs](/research/bridge/succinct): Deep dive on Succinct labs Proof of Consensus for Ethreum.
