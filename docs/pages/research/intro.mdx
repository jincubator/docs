...
This knowledge base and learning center is based upon research done around trading, payments, solving, arbitrage and market making infrastructure.
...
You can find me on telegram @john_whitton.

### Thanks to the thought leaders

John would like to thank

- [Circle](https://circle.com): For their leadership in building a payment infrastucture and full stack platform for onchain and scaled financial systems.
- [FalconX](https://FalconX.io): For it's work as institutional gateway to digital asset markets.
