...
The figure below is a source-backed reference architecture distilled from the implementation repository's accepted design, ADRs, current status, and module boundaries. It shows the API, domain/application, durable-delivery, adapter, observation, and reconciliation seams that the reference implementation demonstrates. It is not deployment documentation: the evidence remains local and non-production, and the figure does not assert production custody, public-network operation, or settlement.

<img src="/assets/work/digital-banking/digital-banking-control-plane.svg" alt="Digital Banking reference architecture from API composition through durable delivery, external evidence, and reconciliation" />
