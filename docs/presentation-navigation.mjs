...
const archiveItems = [
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Ethereum Near Bridging", link: "/research/code/ethereum-near" },
        ],
      },
      {
        ...
        items: [
          ...
          { text: "Near Rainbow Bridge", link: "/research/bridge/near-rainbow" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Circle Architecture Research Dossier", link: "/research/architecture/circle" },
          { text: "FalconX Architecture Research Dossier", link: "/research/architecture/falconx" },
          { text: "System Design & Architecture Portfolio", link: "/research/architecture/john" },
          { text: "Overview", link: "/research/deprecated/architecture" },
          { text: "IntentSwap", link: "/research/deprecated/flow" },
          { text: "Uniswap V4 Hook Development — WIP", link: "/research/deprecated/hooks" },
          { text: "Solving and Arbitrage Research", link: "/research/deprecated/intro" },
          { text: "Protocol", link: "/research/deprecated/protocol" },
          { text: "Resource Management", link: "/research/deprecated/resources" },
          { text: "Distributed Systems", link: "/research/distributed-systems/intro" },
          { text: "Financial Infrastructure", link: "/research/financial-infrastructure/intro" },
          { text: "Payments", link: "/research/financial-infrastructure/payments/intro" },
          { text: "Stablecoins", link: "/research/financial-infrastructure/stablecoins/intro" },
          { text: "Tycho and 1inch Solving", link: "/research/solving/tycho1inchNOL" },
  ...
  },
  {
    ...
    collapsed: true,
    items: [
      { text: "AI Systems Architecture", link: "/architecture/ai-systems/intro" },
      { text: "DeFi Systems Architecture", link: "/architecture/defi-systems/intro" },
      { text: "Distributed Systems Architecture", link: "/architecture/distributed-systems/intro" },
      { text: "Enterprise Architecture", link: "/architecture/enterprise-architecture/intro" },
      { text: "Financial Infrastructure Architecture", link: "/architecture/financial-infrastructure/intro" },
      { text: "Architecture Portfolio", link: "/architecture/portfolio" },
      { text: "Reference Architecture: FalconX", link: "/architecture/trading-systems/falconx" },
      { text: "Trading Systems Architecture", link: "/architecture/trading-systems/intro" },
    ],
  },
  {
    text: "Product",
    collapsed: true,
    items: [
      { text: "Project-X Technical White Paper", link: "/product/previous/2018-07-17-projectx" },
      { text: "Lessons Learned from Devcon5", link: "/product/previous/2019-10-16-devcon5" },
      { text: "EAVE Parachain Design", link: "/product/previous/2021-04-01-eave-parachain" },
      { text: "Kanga Protocol Whitepaper", link: "/product/previous/2021-05-01-kanga" },
      { text: "Draft EAVE Whitepaper", link: "/product/previous/2021-12-01-eave-defi" },
      { text: "Ethereum Bridging using Light Clients — Rainbow Costing", link: "/product/previous/2023-02-23-rainbow-costs" },
    ],
  },
  {
    text: "Proposals",
    collapsed: true,
    items: [
      { text: "Kanga Finance: Harmony Hackathon 2021", link: "/proposals/Harmony" },
      { text: "Research Proposal: Solvers, Arbitrage & Intent-Based Protocols", link: "/proposals/solving-arbitrage" },
