import{u as a,j as e}from"./index-B37rXnrm.js";import{Z as r}from"./ZoomImage-Cks4qyeM.js";/* empty css               */const c={title:"Overview",description:"undefined"};function i(t){const n={a:"a",blockquote:"blockquote",defs:"defs",div:"div",em:"em",g:"g",h1:"h1",h2:"h2",header:"header",li:"li","mjx-container":"mjx-container",p:"p",path:"path",style:"style",svg:"svg",ul:"ul",use:"use",...a(),...t.components},s=n["mjx-container"];return e.jsxs(e.Fragment,{children:[e.jsx(n.blockquote,{"data-historical-context":"true",children:e.jsxs(n.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(n.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,`
`,e.jsx(n.header,{children:e.jsxs(n.h1,{id:"overview",children:["Overview",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#overview",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
`,e.jsx(n.p,{children:"This is an opinionated architecture for an intent based solving protocol which facilitates single- and multichain solving of intents. Flash liquidity can remove the need to pre-fund trading principal. Infrastructure, data/RPC, operational, and transaction-gas costs still exist; reverted, unsuccessful, or non-included attempts may leave unreimbursed costs."}),`
...
`,e.jsx(n.li,{children:"Ability for solvers to execute fills without pre-funding trading principal; infrastructure and transaction costs remain"}),`
`]}),`
...
`]}),`
`,e.jsxs(n.h2,{id:"architecture-digrams",children:["Architecture Digrams",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#architecture-digrams",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(r,{src:"/images/IntentSwapProtocolMonoChain.png",alt:"IntentSwap Components",title:"IntentSwap Components"}),`
...
`})]})}function h(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{h as default,c as frontmatter};
