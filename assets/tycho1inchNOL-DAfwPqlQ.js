import{f as r,j as e}from"./index-gXrJDCdi.js";const a={title:"No Liquidity Solving (Tycho 1inch)",description:"undefined"};function i(n){const s={a:"a",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",header:"header",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.header,{children:e.jsxs(s.h1,{id:"no-liquidity-solving-tycho-1inch",children:["No Liquidity Solving (Tycho 1inch)",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#no-liquidity-solving-tycho-1inch",children:e.jsx(s.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsxs(s.p,{children:["This research was conducted as part of ",e.jsx(s.a,{href:"https://ethglobal.com/showcase/defiunite-jincubator-g1h0p",children:"Unite DeFi"})]}),`
