import{u as a,j as e}from"./index-Cqvlv1P0.js";import{Z as r}from"./ZoomImage-DBvrOQcF.js";const d={title:"Overview",description:"undefined"};function i(t){const n={a:"a",blockquote:"blockquote",defs:"defs",div:"div",em:"em",g:"g",h1:"h1",h2:"h2",header:"header",li:"li","mjx-container":"mjx-container",p:"p",path:"path",style:"style",svg:"svg",ul:"ul",use:"use",...a(),...t.components},s=n["mjx-container"];return e.jsxs(e.Fragment,{children:[e.jsx(n.blockquote,{"data-historical-context":"true",children:e.jsxs(n.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(n.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,`
