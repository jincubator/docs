import{u as t,j as e}from"./index-B37rXnrm.js";const o={title:"DeFi Protocol Engineering — Kanga",description:"A bounded case study of Kanga protocol design, AMM mechanics, incentives, staking, fee conversion, migration, and controls."};function r(i){const n={a:"a",button:"button",code:"code",div:"div",h1:"h1",h2:"h2",header:"header",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[`
...
`,e.jsxs(n.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Kanga AMM, incentives, staking, fee conversion, and migration architecture",children:[e.jsx("img",{src:"/assets/work/defi-protocol-engineering-kanga/kanga-amm-incentives-migration.svg",alt:"Kanga AMM, incentives, staking, fee conversion, and migration architecture"}),e.jsx(n.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]}),`
`,e.jsxs(n.p,{children:[e.jsx("a",{href:"/assets/work/defi-protocol-engineering-kanga/kanga-amm-incentives-migration.svg",children:"Open the full-size Kanga protocol architecture diagram"}),"."]}),`
