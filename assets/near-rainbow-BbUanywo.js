import{u as i,j as e}from"./index-CIl2iKtF.js";const a={title:"Near Rainbow Bridge",description:"undefined"};function r(n){const s={a:"a",blockquote:"blockquote",button:"button",code:"code",defs:"defs",div:"div",em:"em",g:"g",h1:"h1",h2:"h2",h3:"h3",header:"header",img:"img",li:"li","mjx-container":"mjx-container",ol:"ol",p:"p",path:"path",pre:"pre",span:"span",strong:"strong",style:"style",svg:"svg",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",use:"use",...i(),...n.components},t=s["mjx-container"];return e.jsxs(e.Fragment,{children:[e.jsx(s.blockquote,{"data-historical-context":"true",children:e.jsxs(s.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(s.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,e.jsx(s.header,{children:e.jsxs(s.h1,{id:"near-rainbow-bridge",children:["Near Rainbow Bridge",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#near-rainbow-bridge",children:e.jsx(s.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsxs(s.li,{children:[e.jsx(s.code,{children:"get_block_number_for_slot(...)"}),": Validates that the finalized block number is correct on Ethereum using the ",e.jsx(s.code,{children:"beacon_rpc_client"}),"."]}),`
...
`]}),`
`]}),`
`,e.jsxs(s.h3,{id:"nearbridge-cryptographic-primitives",children:["Nearbridge Cryptographic Primitives",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#nearbridge-cryptographic-primitives",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
...
`]}),`
`,e.jsxs(s.h3,{id:"near-to-ethereum-block-propagation-components",children:["NEAR to Ethereum block propagation components",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#near-to-ethereum-block-propagation-components",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
...
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:["Has ",e.jsx(s.a,{href:"https://github.com/aurora-is-near/rainbow-bridge/blob/master/near2eth/near2eth-block-relay/package.json",children:"dependencies"})," including ",e.jsx(s.a,{href:"https://github.com/aurora-is-near/rainbow-bridge/tree/master/utils",children:"rainbow-bridge-utils"}),". Its other dependencies are also included in ",e.jsx(s.code,{children:"rainbow-bridge-utils"}),".",`
`,e.jsxs(s.ul,{children:[`
...
`,e.jsx(s.p,{children:e.jsxs(s.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Ethereum to Near Funds Transfer",children:[e.jsx(s.img,{src:"/posts/2023-02-05-ethereum-bridging-costs/eth2NearFundsTransfer.jpg",alt:"Ethereum to Near Funds Transfer",title:"Ethereum to NEAR Funds Transfer",className:"jincubator-image-zoom__image"}),e.jsx(s.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]})}),`
