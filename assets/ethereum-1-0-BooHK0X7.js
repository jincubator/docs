import{u as i,j as e}from"./index-CRHKTRWf.js";const a={title:"Ethereum 1.0",description:"undefined"};function n(r){const s={a:"a",blockquote:"blockquote",button:"button",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",header:"header",img:"img",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.blockquote,{"data-historical-context":"true",children:e.jsxs(s.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(s.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,e.jsx(s.header,{children:e.jsxs(s.h1,{id:"ethereum-10",children:["Ethereum 1.0",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#ethereum-10",children:e.jsx(s.div,{"data-autolink-icon":!0})})]})}),`
...
`]}),`
`,e.jsx(s.p,{children:e.jsxs(s.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Proof Of Work",children:[e.jsx(s.img,{src:"/images/research/pow.png",alt:"Proof Of Work",title:"Proof Of Work",className:"jincubator-image-zoom__image"}),e.jsx(s.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]})}),`
...
`,e.jsxs(s.li,{children:[e.jsx(s.a,{href:"https://takenobu-hs.github.io/downloads/ethereum_evm_illustrated.pdf",children:"Ethereum EVM illustrated"}),": A technical overview of Ethereum including state, accounts, transactions and messages as well as the EVM. ",e.jsx(s.a,{href:"/research/code/ethereum#appendix-e-data-structures",children:"Appendix E"})," has links to type definitions for blocks, transactions, state etc in geth."]}),`
`]})]})}function h(r={}){const{wrapper:s}={...i(),...r.components};return s?e.jsx(s,{...r,children:e.jsx(n,{...r})}):n(r)}export{h as default,a as frontmatter};
