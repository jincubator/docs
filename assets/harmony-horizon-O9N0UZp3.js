import{u as t,j as e}from"./index-CIl2iKtF.js";const s={title:"Harmony Horizon",description:"undefined"};function r(i){const n={a:"a",blockquote:"blockquote",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",header:"header",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.blockquote,{"data-historical-context":"true",children:e.jsxs(n.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(n.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,e.jsx(n.header,{children:e.jsxs(n.h1,{id:"harmony-horizon",children:["Harmony Horizon",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#harmony-horizon",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsxs(n.p,{children:["Further thoughs on ETH 2.0 support, removing the ETHHASH logic and SPV client and potentially replacing with MMR trees per epoch and checkpoints similar to Harmony Light Client on Ethereum, can find inspiration in ",e.jsx(n.a,{href:"/research/bridge/near-rainbow",children:"near-rainbow"}),"."]}),`
...
`,e.jsx(n.p,{children:e.jsxs(n.em,{children:["Note these contracts were planned to be implemented with Harmony Light Client support which includes Merkle Mountain Ranges (see this ",e.jsx(n.a,{href:"https://github.com/harmony-one/harmony/pull/3872",children:"PR"})," and this ",e.jsx(n.a,{href:"/research/chains/harmony#light-client-support",children:"review"}),"). The planned timeline for implementing this had not been finalized as of Feb 2023."]})}),`
`,e.jsxs(n.ul,{children:[`
