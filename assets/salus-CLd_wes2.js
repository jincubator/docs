import{u as r,j as e}from"./index-j4tXYcFA.js";const t={title:"Salus — Active Trading-System Research",description:"The architecture, engineering contribution, retained results, and limitations of the Salus trading-system reference implementation."};function n(i){const s={a:"a",button:"button",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[`
