import{f as r,j as e}from"./index-pF_EkFhp.js";const l={title:"Salus — Active Trading-System Research",description:"The architecture, engineering contribution, retained results, and limitations of the Salus trading-system reference implementation."};function n(i){const s={a:"a",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[`
...
`,e.jsx("img",{src:"/assets/work/salus/salus-runtime-architecture.png",alt:"Salus runtime architecture showing external state, configuration boundaries, state and persistence, the runtime hot path, and execution controls."}),`
...
`,e.jsx("img",{src:"/assets/work/salus/salus-code-walkthrough.png",alt:"Salus code walkthrough showing public runtime ownership, route evaluation, execution handoff, persistence, and evidence boundaries."}),`
...
does not present it as a visitor destination or copy its living documentation.`})]})}function t(i={}){const{wrapper:s}={...r(),...i.components};return s?e.jsx(s,{...i,children:e.jsx(n,{...i})}):n(i)}export{t as default,l as frontmatter};
