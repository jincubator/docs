import{u as r,j as e}from"./index-B37rXnrm.js";const s={title:"Salus Architecture Overview — Legacy Route",description:"Public architectural summary of the Salus trading-system research and reference implementation."};function n(i){const t={a:"a",blockquote:"blockquote",div:"div",h1:"h1",header:"header",li:"li",ol:"ol",p:"p",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.blockquote,{"data-historical-context":"true",children:e.jsxs(t.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(t.a,{href:"/archive",children:"Archive"})," for context."]})}),`
