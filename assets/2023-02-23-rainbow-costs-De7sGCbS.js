import{u as i,j as e}from"./index-B37rXnrm.js";import{Z as a}from"./ZoomImage-Cks4qyeM.js";/* empty css               */const o={title:"Ethereum Bridging using Light Clients - Rainbow Costing",description:"undefined"};function n(r){const s={a:"a",blockquote:"blockquote",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.blockquote,{"data-historical-context":"true",children:e.jsxs(s.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(s.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,`
`,e.jsx(s.header,{children:e.jsxs(s.h1,{id:"ethereum-bridging-using-light-clients---rainbow-costing",children:["Ethereum Bridging using Light Clients - Rainbow Costing",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#ethereum-bridging-using-light-clients---rainbow-costing",children:e.jsx(s.div,{"data-autolink-icon":!0})})]})}),`
`,e.jsx(s.p,{children:"This research was done in conjunction with the Harmony team in early 2022."}),`
...
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[e.jsx(s.a,{href:"#ethereum-bridging-using-light-clients---rainbow-costing",children:"Ethereum Bridging using Light Clients - Rainbow Costing"}),`
`,e.jsxs(s.ul,{children:[`
...
`,e.jsx(a,{src:"/posts/2023-03-23-rainbow-costs/eth2NearFundsTransfer.jpg",alt:"Ethereum to NEAR Funds Transfer"}),`
...
`]}),`
`]}),`
`]})]})}function h(r={}){const{wrapper:s}={...i(),...r.components};return s?e.jsx(s,{...r,children:e.jsx(n,{...r})}):n(r)}export{h as default,o as frontmatter};
