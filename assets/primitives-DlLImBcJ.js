import{u as s,j as e}from"./index-j4tXYcFA.js";const h={title:"Cryptographic Primitives",description:"undefined"};function n(i){const r={a:"a",blockquote:"blockquote",code:"code",div:"div",h1:"h1",h2:"h2",header:"header",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(r.blockquote,{"data-historical-context":"true",children:e.jsxs(r.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(r.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,e.jsx(r.header,{children:e.jsxs(r.h1,{id:"cryptographic-primitives",children:["Cryptographic Primitives",e.jsx(r.a,{"aria-hidden":"true",tabIndex:"-1",href:"#cryptographic-primitives",children:e.jsx(r.div,{"data-autolink-icon":!0})})]})}),`
...
`]})]})}function o(i={}){const{wrapper:r}={...s(),...i.components};return r?e.jsx(r,{...i,children:e.jsx(n,{...i})}):n(i)}export{o as default,h as frontmatter};
