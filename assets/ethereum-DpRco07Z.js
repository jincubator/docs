import{u as a,j as s}from"./index-BAajr7fb.js";const r={title:"Ethereum",description:"undefined"};function i(n){const e={a:"a",blockquote:"blockquote",button:"button",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",header:"header",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...a(),...n.components};return s.jsxs(s.Fragment,{children:[s.jsx(e.blockquote,{"data-historical-context":"true",children:s.jsxs(e.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",s.jsx(e.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,s.jsx(e.header,{children:s.jsxs(e.h1,{id:"ethereum",children:["Ethereum",s.jsx(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#ethereum",children:s.jsx(e.div,{"data-autolink-icon":!0})})]})}),`
...
`,s.jsxs(e.p,{children:["With the Introduction of Ethereum 2.0",s.jsx("sup",{children:"1"})," ",s.jsx("sup",{children:"2"})," ",s.jsx("sup",{children:"3"})," block production and consensus were separated",s.jsx("sup",{children:"4"})," into execution clients",s.jsx("sup",{children:"5"})," and consensus clients",s.jsx("sup",{children:"6"})," ",s.jsx("sup",{children:"7"}),"."]}),`
`,s.jsxs(e.p,{children:["The execution chain implemented a simplified Proof of Work",s.jsx("sup",{children:"1"})," reducing difficutly to zero and removing the need for omners (uncles) which would now be handled by the beacon chain",s.jsx("sup",{children:"3"})," which is responsible for providing consensus ",s.jsx("sup",{children:"2"}),"."]}),`
`,s.jsxs(e.p,{children:["Light Clients",s.jsx("sup",{children:"11"}),` were also introduced. To facilate this
...
`,s.jsxs(e.p,{children:["As at December 11th, 2022 Ethereum has 487,920 validators",s.jsx("sup",{children:"8"})," with a sample epoch (",s.jsx(e.a,{href:"https://beaconcha.in/epoch/166581",children:"166581"}),") and slot (",s.jsx(e.a,{href:"https://beaconcha.in/slot/5330592",children:"5,330,592"}),") having ",s.jsx(e.a,{href:"https://beaconcha.in/slot/5330592#transactions",children:"139 transactions"})," with ",s.jsx(e.a,{href:"https://beaconcha.in/slot/5330592#votes",children:"19,227 votes"})," from 63 committees and ",s.jsx(e.a,{href:"https://beaconcha.in/slot/5330592#attestations",children:"126 aggregated committe attestations"}),"."]}),`
`,s.jsxs(e.p,{children:["Here is more information on the upgrade",s.jsx("sup",{children:"9"})," and the roadmap",s.jsx("sup",{children:"10"})]}),`
`,s.jsx(e.p,{children:s.jsxs(e.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Ethereum Roadmap",children:[s.jsx(e.img,{src:"/images/research/ethereum-roadmap.jpg",alt:"Ethereum Roadmap",title:"Ethereum Roadmap",className:"jincubator-image-zoom__image"}),s.jsx(e.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]})}),`
...
Following is an excerpt from `,s.jsx(e.a,{href:"https://ethereum.org/en/developers/docs/consensus-mechanisms/pos/",children:"Ethereum.org's proof-of-stake documentation"})]}),`
...
`,s.jsxs(e.p,{children:["Validators run both an Ethereum 1 client (e.g. geth) and a Beacon Chain Client (e.g. prysm). The geth client recieves transactions and places them into blocks. For additional details see the Ethereum Builder Specs",s.jsx("sup",{children:"12"}),". The following diagrams give an overview of how blocks are proposed and how MEV Boost",s.jsx("sup",{children:"13"})," could be integrated. For simplification we can replace mev_boost and relay with geth in the block proposal diagram as the majority of validators simply run a geth node."]}),`
`,s.jsx(e.p,{children:s.jsxs(e.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Block Proposal",children:[s.jsx(e.img,{src:"/images/research/block-proposal.png",alt:"Block Proposal",title:"Block Proposal",className:"jincubator-image-zoom__image"}),s.jsx(e.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]})}),`
`,s.jsxs(e.h3,{id:"slots-and-epochs-6",children:["Slots and Epochs ",s.jsx("sup",{children:"6"}),s.jsx(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#slots-and-epochs-6",children:s.jsx(e.div,{"data-autolink-icon":!0})})]}),`
`,s.jsxs(e.blockquote,{children:[`
...
`]}),`
`,s.jsx(e.p,{children:s.jsxs(e.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Slots and Epochs",children:[s.jsx(e.img,{src:"/images/research/Beacon-Chain-Slots-and-Epochs.png.webp",alt:"Slots and Epochs",title:"Slots and Epochs",className:"jincubator-image-zoom__image"}),s.jsx(e.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]})}),`
...
`,s.jsxs(e.p,{children:["This proposed block is attested to by other validators who have been assigned as committe members for this slot",s.jsx("sup",{children:"6b"}),"."]}),`
`,s.jsxs(e.blockquote,{children:[`
...
`]}),`
`,s.jsx(e.p,{children:s.jsxs(e.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Validators and Attestations",children:[s.jsx(e.img,{src:"/images/research/Beacon-Chain-Validators.png",alt:"Validators and Attestations",title:"Validators and Attestations",className:"jincubator-image-zoom__image"}),s.jsx(e.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]})}),`
...
`]}),`
`,s.jsx(e.p,{children:s.jsxs(e.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Committees",children:[s.jsx(e.img,{src:"/images/research/Beacon-Chain-RANDAO.png",alt:"Committees",title:"Committees",className:"jincubator-image-zoom__image"}),s.jsx(e.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]})}),`
...
`,s.jsxs(e.p,{children:["The attestation lifecyle",s.jsx("sup",{children:"9"})," involves"]}),`
...
`]}),`
`,s.jsx(e.p,{children:s.jsxs(e.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Attestation Life Cycle",children:[s.jsx(e.img,{src:"/images/research/AttestationLifeCycle.png",alt:"Attestation Life Cycle",title:"Attestation Life Cycle",className:"jincubator-image-zoom__image"}),s.jsx(e.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]})}),`
`,s.jsxs(e.h3,{id:"checkpoints-and-finality6",children:["Checkpoints and Finality",s.jsx("sup",{children:"6"}),s.jsx(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#checkpoints-and-finality6",children:s.jsx(e.div,{"data-autolink-icon":!0})})]}),`
`,s.jsxs(e.blockquote,{children:[`
`,s.jsx(e.p,{children:"When an epoch ends, if its checkpoint has garnered a ⅔ supermajority, the checkpoint gets justified."}),`
`]}),`
`,s.jsx(e.p,{children:s.jsxs(e.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Checkpoints",children:[s.jsx(e.img,{src:"/images/research/Beacon-Chain-Checkpoints.jpg",alt:"Checkpoints",title:"Checkpoints",className:"jincubator-image-zoom__image"}),s.jsx(e.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]})}),`
`,s.jsxs(e.blockquote,{children:[`
...
`]}),`
`,s.jsx(e.p,{children:s.jsxs(e.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Finality",children:[s.jsx(e.img,{src:"/images/research/Beacon-Chain-Justification-and-Finalization.png",alt:"Finality",title:"Finality",className:"jincubator-image-zoom__image"}),s.jsx(e.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]})}),`
`,s.jsxs(e.h3,{id:"sync-committee-10",children:["Sync Committee ",s.jsx("sup",{children:"10"}),s.jsx(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#sync-committee-10",children:s.jsx(e.div,{"data-autolink-icon":!0})})]}),`
...
`,s.jsxs(e.p,{children:["This is used in Altair Light Client -- Sync Protocol",s.jsx("sup",{children:"11"})," which enables the beacon chain to be light client friendly for constrained environments to access Ethereum."]}),`
...
`,s.jsxs(e.p,{children:["Following is an overview of statuses for validators in Ethereum 2.0 phase 0 ",s.jsx("sup",{children:"14"}),"."]}),`
`,s.jsxs(e.blockquote,{children:[`
`,s.jsxs(e.ol,{children:[`
...
`]}),`
`,s.jsx(e.p,{children:s.jsxs(e.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Validator Status Transition",children:[s.jsx(e.img,{src:"/images/research/ValidatorStateTransition.png",alt:"Validator Status Transition",title:"Validator Status Transition",className:"jincubator-image-zoom__image"}),s.jsx(e.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]})}),`
...
`})]}),`
`,s.jsx(e.p,{children:s.jsxs(e.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Ethereum 2 block proof",children:[s.jsx(e.img,{src:"/posts/2023-02-05-ethereum-bridging-costs/ETH_2_0_MMR.jpg",alt:"Ethereum 2 block proof",title:"Ethereum 2 Block Proof",className:"jincubator-image-zoom__image"}),s.jsx(e.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]})}),`
`,s.jsxs(e.blockquote,{children:[`
...
messages as well as the EVM. `,s.jsx(e.a,{href:"/research/code/ethereum#appendix-e-data-structures",children:"Appendix E"}),` has links
...
`]}),`
`,s.jsxs(e.li,{children:[`
`,s.jsxs(e.p,{children:[s.jsx(e.a,{href:"https://github.com/ethereum/portal-network-specs/blob/master/beacon-chain/sync-gossip.mdx",children:"Advance Block Headers"}),": A beacon chain client could sync committee to perform ",s.jsx(e.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/sync-protocol.mdx",children:"state updates"}),". The ",s.jsx(e.code,{children:"LightClientSkipSyncUpdate"})," data object allows a client to quickly sync to a recent header with the appropriate sync committee. Once the client establishes a recent header, it could sync to other headers by processing ",s.jsx(e.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/sync-protocol.md#lightclientupdate",children:"LightClientUpdates"}),". These two data types allow a client to stay up-to-date with the beacon chain."]}),`
...
`,s.jsxs(e.ul,{children:[`
`,s.jsxs(e.li,{children:[s.jsx(e.a,{href:"https://github.com/prysmaticlabs/prysm/blob/develop/beacon-chain/core/transition/transition.go",children:"transition.go"}),": implements the whole state transition function which consists of per slot, per-epoch transitions. function ",s.jsx(e.code,{children:"ProcessSlots"})," calls ",s.jsx(e.code,{children:"ProcessEpoch"})," in ",s.jsx(e.a,{href:"https://github.com/prysmaticlabs/prysm/blob/develop/beacon-chain/core/altair/transition.go",children:"beacon-chain/core/altair/transition.go"})]}),`
`]}),`
`]}),`
