import{u as a,j as e}from"./index-M_9vezYc.js";const s={title:"NEAR",description:"undefined"};function o(t){const n={a:"a",blockquote:"blockquote",code:"code",defs:"defs",div:"div",em:"em",g:"g",h1:"h1",h2:"h2",header:"header",li:"li","mjx-container":"mjx-container",ol:"ol",p:"p",path:"path",strong:"strong",style:"style",svg:"svg",ul:"ul",use:"use",...a(),...t.components},i=n["mjx-container"];return e.jsxs(e.Fragment,{children:[e.jsx(n.blockquote,{"data-historical-context":"true",children:e.jsxs(n.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(n.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,e.jsx(n.header,{children:e.jsxs(n.h1,{id:"near",children:["NEAR",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#near",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Light clients operate by periodically fetching instances of ",e.jsx(n.code,{children:"LightClientBlockView"})," via the RPC endpoint described below."]}),`
`]}),`
`,e.jsxs(n.blockquote,{children:[`
...
`})]})}function l(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{l as default,s as frontmatter};
