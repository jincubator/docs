import{u as r,j as e}from"./index-M_9vezYc.js";const t={title:"Succinct Labs",description:"undefined"};function n(i){const s={a:"a",blockquote:"blockquote",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",ol:"ol",p:"p",pre:"pre",section:"section",span:"span",strong:"strong",sup:"sup",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.blockquote,{"data-historical-context":"true",children:e.jsxs(s.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(s.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,e.jsx(s.header,{children:e.jsxs(s.h1,{id:"succinct-labs",children:["Succinct Labs",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#succinct-labs",children:e.jsx(s.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(s.span,{className:"line",children:e.jsx(s.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"PHASE1=./powersOfTau28_hez_final_27.ptau"})}),`
