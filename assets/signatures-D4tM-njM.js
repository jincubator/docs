import{u as t,j as e}from"./index-BdRdoMvu.js";const h={title:"Signature Schemes in Consensus Protocols",description:"undefined"};function i(r){const s={a:"a",blockquote:"blockquote",div:"div",h1:"h1",h2:"h2",h3:"h3",h4:"h4",header:"header",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.blockquote,{"data-historical-context":"true",children:e.jsxs(s.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(s.a,{href:"/archive",children:"Archive"})," for context."]})}),`
