import{u as t,j as e}from"./index-CRHKTRWf.js";const r={title:"Binance Smart Chain",description:"undefined"};function s(i){const n={a:"a",blockquote:"blockquote",div:"div",em:"em",h1:"h1",h2:"h2",header:"header",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.blockquote,{"data-historical-context":"true",children:e.jsxs(n.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(n.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,e.jsx(n.header,{children:e.jsxs(n.h1,{id:"binance-smart-chain",children:["Binance Smart Chain",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#binance-smart-chain",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsxs(n.p,{children:["The consensus protocol is based on Parlia",e.jsx("sup",{children:"19"}),", a variation that adds staking, validators, and elections to the proof-of-authority consensus protocol Clique, initially proposed in the Ethereum community. The protocol uses 21 validators for producing and signing blocks, with 19 of them picked from stakers with top voting power and 2 randomly chosen every 200 blocks ",e.jsx("sup",{children:"20"}),". Blocks are signed using ECDSA on secp256k1 curves, and block headers can be verified following the standard signature verification process",e.jsx("sup",{children:"21"}),"."]}),`
...
`,e.jsxs(n.p,{children:["The Binance Smart chain is cloned from ",e.jsx(n.a,{href:"/research/chains/ethereum-1-0",children:"Ethereum 1.0"})," and thus the majority of code incuding primitives, signing are similar. The key addtions are"]}),`
`,e.jsxs(n.ul,{children:[`
...
`]})]})}function o(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{o as default,r as frontmatter};
