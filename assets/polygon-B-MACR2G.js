import{u as r,j as e}from"./index-BAajr7fb.js";const o={title:"Polygon",description:"undefined"};function i(n){const s={a:"a",blockquote:"blockquote",button:"button",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",header:"header",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.blockquote,{"data-historical-context":"true",children:e.jsxs(s.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(s.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,e.jsx(s.header,{children:e.jsxs(s.h1,{id:"polygon",children:["Polygon",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#polygon",children:e.jsx(s.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsxs(s.p,{children:["The consensus protocol is based on Peppermint",e.jsx("sup",{children:"8"}),", a modified version of Tendermint. Validators sign produced blocks using the ECDSA signature scheme on secp256k1 curves",e.jsx("sup",{children:"9"}),". Currently, the validator set size is fixed at 100 and only changes when a current validator resigns. This restriction will change when a new auction mechanism is implemented.",e.jsx("sup",{children:"10"})]}),`
...
`,e.jsx(s.p,{children:e.jsxs(s.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Matic Structure",children:[e.jsx(s.img,{src:"/images/research/matic_structure.png",alt:"Matic Structure",title:"Matic Structure",className:"jincubator-image-zoom__image"}),e.jsx(s.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]})}),`
