import{u as r,j as e}from"./index-j4tXYcFA.js";const o={title:"Cosmos IBC",description:"undefined"};function n(s){const i={a:"a",blockquote:"blockquote",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",p:"p",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(i.blockquote,{"data-historical-context":"true",children:e.jsxs(i.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(i.a,{href:"/archive",children:"Archive"})," for context."]})}),`
