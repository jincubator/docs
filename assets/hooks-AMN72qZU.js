import{u as t,j as e}from"./index-M_9vezYc.js";const r={title:"Uniswap V4 Hook Development - WIP",description:"undefined"};function o(i){const n={a:"a",blockquote:"blockquote",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",ol:"ol",p:"p",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.blockquote,{"data-historical-context":"true",children:e.jsxs(n.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(n.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,e.jsx(n.header,{children:e.jsxs(n.h1,{id:"uniswap-v4-hook-development---wip",children:["Uniswap V4 Hook Development - WIP",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#uniswap-v4-hook-development---wip",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`]}),`
`]}),`
`]})]})}function a(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(o,{...i})}):o(i)}export{a as default,r as frontmatter};
