import{u as r,j as e}from"./index-B37rXnrm.js";const t={title:"Salus — Active Trading-System Research",description:"The architecture, engineering contribution, retained results, and limitations of the Salus trading-system reference implementation."};function n(i){const s={a:"a",button:"button",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[`
...
`,e.jsx(s.p,{children:`Salus is an active Jincubator research and engineering initiative and
reference implementation for decentralized trading-system architecture.`}),`
`,e.jsxs(s.h2,{id:"start-here",children:["Start here",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#start-here",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
...
`,e.jsxs(s.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: Salus code walkthrough showing public runtime ownership, route evaluation, execution handoff, persistence, and evidence boundaries.",children:[e.jsx("img",{src:"/assets/work/salus/salus-code-walkthrough.png",alt:"Salus code walkthrough showing public runtime ownership, route evaluation, execution handoff, persistence, and evidence boundaries."}),e.jsx(s.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]}),`
`,e.jsxs(s.p,{children:[e.jsx("a",{href:"/assets/work/salus/salus-code-walkthrough.png",children:"Open the technical code walkthrough at full size"}),"."]}),`
...
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[e.jsxs(s.strong,{children:[e.jsx(s.a,{href:"/work/salus",children:"Salus overview"}),":"]}),` the integrated account of what John built,
