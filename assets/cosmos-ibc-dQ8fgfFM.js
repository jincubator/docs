import{f as r,j as e}from"./index-Zlve6v8x.js";const o={title:"Cosmos IBC",description:"undefined"};function n(i){const s={a:"a",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",p:"p",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.header,{children:e.jsxs(s.h1,{id:"cosmos-ibc",children:["Cosmos IBC",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#cosmos-ibc",children:e.jsx(s.div,{"data-autolink-icon":!0})})]})}),`
