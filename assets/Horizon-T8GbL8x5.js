import{u as r,j as e}from"./index-BdRdoMvu.js";const t={title:"Horizon Bridge",description:"undefined"};function s(i){const n={a:"a",blockquote:"blockquote",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.blockquote,{"data-historical-context":"true",children:e.jsxs(n.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(n.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,e.jsx(n.header,{children:e.jsxs(n.h1,{id:"horizon-bridge",children:["Horizon Bridge",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#horizon-bridge",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`]}),`
`,e.jsxs(n.h2,{id:"historical-implementation-walkthrough",children:["Historical implementation walkthrough",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#historical-implementation-walkthrough",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
