import{f as s,j as e}from"./index-DN_mJsf2.js";const o={title:"Uniswap V4 Intent Hook",description:"undefined"};function t(i){const n={a:"a",div:"div",h1:"h1",h2:"h2",h3:"h3",h4:"h4",header:"header",li:"li",ol:"ol",p:"p",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"uniswap-v4-intent-hook",children:["Uniswap V4 Intent Hook",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#uniswap-v4-intent-hook",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
