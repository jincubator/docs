import{u as s,j as e}from"./index-AG_q_k1k.js";const o={title:"Cosmos",description:"undefined"};function t(i){const n={a:"a",blockquote:"blockquote",button:"button",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",header:"header",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.blockquote,{"data-historical-context":"true",children:e.jsxs(n.p,{children:["Historical page retained for compatibility. It may contain superseded assumptions, incomplete plans, or outdated links and is not current canonical content. See the ",e.jsx(n.a,{href:"/archive",children:"Archive"})," for context."]})}),`
`,e.jsx(n.header,{children:e.jsxs(n.h1,{id:"cosmos",children:["Cosmos",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#cosmos",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsxs(n.p,{children:["Cosmos is the hub to almost 50 blockchains based on the Tendermint consensus engine and Inter-Blockchain Communication (IBC) protocol. It is also one of the earliest proponents for cross-chain communication and defined the first set of communication specificiations",e.jsx("sup",{children:"24"}),". From a purely technical point of view, the signature scheme for signing blocks, Ed25519, is also often used in many other protocols, such as NEAR."]}),`
`,e.jsxs(n.p,{children:["Cosmos Hub itself has 175 validators",e.jsx("sup",{children:"25"})," and is built upon Tendermint, in which validators sign blocks using EdDSA on Curve25519 (i.e., Ed25519)",e.jsx("sup",{children:"26"}),"."]}),`
...
`]}),`
`,e.jsx(n.p,{children:e.jsxs(n.button,{type:"button",className:"jincubator-image-zoom","aria-label":"Open full-size image: consensus-logic",children:[e.jsx(n.img,{src:"/images/research/tendermint_consensus_logic.png",alt:"consensus-logic",className:"jincubator-image-zoom__image"}),e.jsx(n.span,{className:"jincubator-image-zoom__indicator","aria-hidden":"true"})]})}),`
`,e.jsxs(n.blockquote,{children:[`
